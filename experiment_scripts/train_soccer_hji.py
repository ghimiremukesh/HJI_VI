...
dataset = dataio.SoccerHJI(numpoints=30000, theta=opt.theta, velocity=0, u_max=0.5, d_max=0.3, tMin=opt.tMin,
...
root_path = os.path.join(opt.logging_root, 'soccer_hji_exp_increased_a/')

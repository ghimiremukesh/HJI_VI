...
p.add_argument('--tMax', type=float, default=3.0, required=False, help='End time of the simulation')
...
dataset = dataio.SoccerHJI(numpoints=10000, theta=opt.theta, velocity=0, u_max=0.5, d_max=0.3, tMin=opt.tMin,

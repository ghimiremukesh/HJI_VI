...
p.add_argument('--tMax', type=float, default=1, required=False, help='End time of the simulation')
...
p.add_argument('--theta', default=1, help="Type Left (-1) or Right (1)")
...
assert opt.theta == -1 or opt.theta == 1
...
dataset = dataio.SoccerHJI(numpoints=30000, theta=opt.theta, velocity=0, u_max=0.1, d_max=0.05, tMin=opt.tMin,
...
root_path = os.path.join(opt.logging_root, 'soccer_hji_exp/')

...
def train(model, train_dataloader, train_dataloader_supervised, epochs, lr, steps_til_summary, epochs_til_checkpoint, model_dir,
          ...
          use_lbfgs=False, loss_schedules=None, validation_fn=None, start_epoch=0, pretrain=False, pretrain_iters=1000):
    ...
    with tqdm(total=len(train_dataloader) * epochs - start_epoch) as pbar:
        ...
        for epoch in range(start_epoch, epochs):
            # schedule beta
            if epoch > 10000:  # after pretraining on the boundary value
                if beta >= 10000:
                     beta = 10000
                else:
                    beta *= (2*(epoch+1))
            ...
            if pretrain:
                ...
                for step, (model_input, gt) in enumerate(train_dataloader):
                    ...
                    losses = loss_fn(model_output, gt, beta)

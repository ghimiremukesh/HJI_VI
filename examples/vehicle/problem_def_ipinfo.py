...
class setup_problem(problem_prototype):
    def __init__(self):
        ...
        self.theta1_a = 1  # [1, 5]
        self.theta1_na = 5  # [1, 5]
        self.theta2_a = 1  # [1, 5]
        self.theta2_na = 5  # [1, 5]
        ...
        # Probability for aggressive and non-aggressive of theta1 and theta2 respectively
        '''
        P1 is aggressive for theta1, P2 is aggressive for theta2
        '''
        self.P1 = 0.4
        self.P2 = 0.6

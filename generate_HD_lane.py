...
from examples.choose_problem_HD_lane import system, problem, config
...
idx = 2  # change the case you choose
...
save_path = 'examples/' + system + '/data_' + data_type + f'_{tag}_1.mat'
print(save_path)
